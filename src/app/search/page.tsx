  ...
  return (
    <main className="flex h-[100dvh] flex-col items-center justify-center font-inter p-6 pt-[90px] am-ami-container-sm">
      <div className="flex items-center justify-center w-[min(320px,100%)] m-auto relative">
        ...
        <div className="flex-1 flex gap-1 pl-9 pr-4 py-2 text-gray-900 border border-[#396AF6] bg-gray-50  rounded-3xl -ms-7">
          <input
            type="text"
            id="large-input"
            pattern="^[a-z0-9_]+$"
        ...
        {inputValue && (
          <div
            ...
            className="absolute text-left bg-white w-full m-auto mt-1 border outline-none focus:outline-none border-borderGrey left-1/2 transform -translate-x-1/2 cursor-pointer hover:bg-grey max-w-[95%] top-[50px]"
          >
      ...
      {inputValue?.length > 0 && !ValidInput && (
