...
export default function Footer() {
  ...
  return (
    <>
      {!pathname.includes("claim") && !pathname.includes("profile") ? (
          ...
          <div className="flex items-center justify-between border-b border-b-[#485053] pb-8">
            ...
            <div className="flex items-center gap-12">
              <Link href={contactUsUrl} target="_blank">
                <p className="text-[20px] text-white leading-6 font-semibold font-inter">
                  Contact us
                </p>
              </Link>
            </div>
          ...
          <div className="flex flex-col items-center justify-center mt-12">
            <Link href={blocktheoryUrl} target="_blank">
              <div className="flex items-center justify-center gap-2">
                <p className="text-[20px] text-white leading-6 font-semibold font-inter hidden md:block">
                  Built by
                </p>
                <Image className="" alt="selected" src={icons.logo} />
              </div>
              <p className="paragraph_regular !text-white !text-center font-inter">
                Blockchain R&D Hub
              </p>
            </Link>
          </div>
        ...
        <div
          className={`bg-white flex flex-col items-center justify-center mb-12 mt-8 md:mt-0`}
        >
          <Link href={blocktheoryUrl} target="_blank">
            <div className="flex flex-col items-center justify-center">
              <p className="text-[12px] text-black leading-6 font-normal font-inter">
                Built by
              </p>
